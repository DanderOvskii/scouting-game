...
namespace TarodevController2
{
    ...
    /// </summary>
    public class PlayerController : MonoBehaviour, IPlayerController2
    {
        ...
        private void GatherInput() {
            Input = new FrameInput {
                JumpDown = UnityEngine.Input.GetButtonDown("arrowup"),
                JumpUp = UnityEngine.Input.GetButtonUp("arrowup"),
                X = UnityEngine.Input.GetAxisRaw("arrows")
            };
            if (Input.JumpDown) {
